...
$LANGUAGE=array(
    ...
    'ADMINSERVICE_ERROR_CODE_MINUS_THREE'=>'错误: 请求已超时',
    'ADMINSERVICE_ERROR_CODE_MINUS_FOUR'=>'错误: 请求已过期',
    'ADMINSERVICE_ERROR_CODE_MINUS_FIVES'=>'错误: 签名校验失败',
    'PERMISSION_ERROR_NO_PERMISSION_ONE'=>'节点缺少权限'
);
